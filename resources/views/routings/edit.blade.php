            ...
            <div class="card-body">
                ...
                <form action="{{ route('routing.update', $routing->id) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="load_height" id="load_height" class="form-control custom-input" value="{{ $routing->load_height }}" required>
                    </div>
                    <div class="form-group">
                        <label for="load_width">Ширина груза</label>
                        <input type="text" name="load_width" id="load_width" class="form-control custom-input" value="{{ $routing->load_width }}" required>
                    </div>
                    <div class="form-group">
                        <label for="load_length">Длина груза</label>
                        <input type="text" name="load_length" id="load_length" class="form-control custom-input" value="{{ $routing->load_length }}" required>
                    </div>
                    <div class="form-group">
